...
define( 'IMAGETYPE_ICO', IMAGETYPE_WBMP << 10 );
...
{
$tmp = '/tmp/'.uniqid( 'ico_' ).'.ico';
if( ! file_put_contents( $tmp, @file_get_contents( $filename ) ) ) return NULL;
$filename = $tmp;

$Ikona=GetIconsInfo($filename);
if( empty( $Ikona ) ) return NULL;
